...
def register(show_spinner=False) -> str | None:
  ...
  """
  params = Params()
  dongle_param = "KonikDongleId" if params.get_bool("KonikApi") else "CommaDongleId"

  dongle_id: str | None = params.get(dongle_param)
  if dongle_id is None and dongle_param == "CommaDongleId" and Path(Paths.persist_root()+"/comma/dongle_id").is_file():
  ...
  if dongle_id:
    ...
    params.put(dongle_param, dongle_id)
