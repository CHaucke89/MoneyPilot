...
void HudRendererSP::drawRightDevUI(QPainter &p, int x, int y) {
  ...
  rh += drawRightDevUIElement(p, x, ry, steeringTorqueEpsElement.value, steeringTorqueEpsElement.label, steeringTorqueEpsElement.units, steeringTorqueEpsElement.color);
  ry = y + rh;
